    ...
    return (
        <div className="mb-12">
            ...
            <p className="text-gray-400 mt-5">
                ...
                Here is my updated <a href="https://drive.google.com/file/d/1Cm_766QSeIykXCLsyAhelbX1ipHbZHoc/view?usp=sharing" download="Md_Raiyanul_Islam_CV.pdf"> <span className="text-lg text-sky-500 font-bold">resume</span>. </a>
            </p>
        </div>
    )
}