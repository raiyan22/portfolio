        ...
        <div className="mb-12">
            ...
            <div className="flex flex-wrap">
                {technologies.map( (item) => (
                    <div className="flex py-1 my-1 sm:py-2 5 px-2 sm:px-3 md:px-4 sm:my-1 mr-2 bg-slate-900 rounded-xl items-center group duration-150">
                        <Image className="w-10 h-10 sm:w-12 sm:h-12 p-1 group-hover:-rotate-[15deg]  transition-all ease-in-out duration-150"  src={item.icon_path} alt={`icon_technology- ${item.label} `} width={25} height={25} />
